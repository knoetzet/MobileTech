...
public class NaturalCultivatedFragment extends Fragment{
    public static NaturalCultivatedFragment newInstance() {
        return new NaturalCultivatedFragment();
    }

    public NaturalCultivatedFragment(){}
